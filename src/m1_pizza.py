...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 5:  5 slices, thin (thickness=2) blue lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 2
    circle.fill_color = 'purple'
    pizza(window, circle, 100, 'orange', 2)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3:
    title = ('POLYGON test3:  3 segments with thick blue lines')
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(100, 100), 120)
    circle.outline_thickness = 1
    circle.fill_color = 'yellow'
    polygon(window, circle, 60, 'green', 10)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    fancy_polygon(window, circle, 50, 17, 'blue', 2)
    window.close_on_mouse_click()
